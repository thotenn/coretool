...
from .utils import unicode_sorter, sort_results
...
class ChainedSelect(JqueryMediaMixin, Select):
    ...
    def media(self):
        ...
        js = ['plugins/smart-selects/admin/js/chainedfk.js',
              'plugins/smart-selects/admin/js/bindfields.js']
        media += Media(js=js)
        return media
...
class ChainedSelectMultiple(JqueryMediaMixin, SelectMultiple):
    ...
    def media(self):
        ...
        js = ['plugins/smart-selects/admin/js/chainedm2m.js',
              'plugins/smart-selects/admin/js/bindfields.js']
        if self.horizontal:
